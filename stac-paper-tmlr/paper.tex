...
and this operator is proved to be a contraction in q-learning setting \citet{achab2020ranking}, but not considered overestimation effects and soft-learning. In the next section, we will discuss overestimation bounds of one-step Bellman optimality operator, and propose a method to mitigate it. 
