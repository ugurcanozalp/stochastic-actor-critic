...
Our method differs from other methods using aleatoric uncertainty for safety \citet{tang2019worst, yang2021wcsac, kim2022efficient, ma2025dsac}. These methods, incorporate total return uncertainty into actor updates, whereas STAC uses temporal (one-step) uncertainty on both critic and actor updates for overestimation mitigation rather than safe learning. However, pessimism in STAC still yields to risk-averse learning. 
